...
public class RewardedNotification extends Worker{
    public RewardedNotification(@NonNull Context context, @NonNull WorkerParameters workerParams) {
