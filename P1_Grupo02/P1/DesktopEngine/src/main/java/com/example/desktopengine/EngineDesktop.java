...
public class EngineDesktop implements IEngine, Runnable {
    ...
    public EngineDesktop(JFrame myView) {
        ...
        myGraphics_ = new GraphicsDesktop(this.myView_); // Inicializa la clase de graficos
        myAudio_ = new AudioDesktop(); // Inicializa la clase de audio
        myInput_ = new InputDesktop(this.myView_); // Inicializa la clase de entrada (input)
        System.out.print("Window Width: " + this.myView_.getWidth() + " Window Height: " + this.myView_.getHeight() + "\n"); // Imprime las dimensiones de la ventana
    }
